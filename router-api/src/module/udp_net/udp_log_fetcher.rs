...
impl UdpLogFetcher {
    ...
    pub fn new() -> Self {
        ...
        Self::with_queue_size(3_000_000)
    }
                    ...
                    Ok((size, src)) => {
                        ...
                        if let Ok(message) = str::from_utf8(&buffer[..size]) {
                            ...
                            let log_message = LogMessage {
                                ...
                                // message_formatted: scoped_format,
                            };
...
mod tests {
    ...
    fn test_udp_log_fetcher() {
        ...
        sender
            .send_to(test_message.as_bytes(), "127.0.0.1:8899")
            .unwrap();
    ...
    fn test_multiple_consumers() {
        ...
        sender
            .send_to(test_message.as_bytes(), "127.0.0.1:8898")
            .unwrap();
    ...
    fn test_queue_size_tracking() {
        ...
        for i in 0..5 {
            ...
            sender
                .send_to(test_message.as_bytes(), "127.0.0.1:8897")
                .unwrap();
        }
        ...
        assert!(
            fetcher.queue_len() > 0,
            "Queue size should be greater than 0"
        );
        ...
        assert!(
            fetcher.queue_len() < 5,
            "Queue size should decrease after consumption"
        );
...
mod multi_port_tests {
    ...
    fn test_multi_port_receiver() {
        ...
        sender
            .send_to(msg1.as_bytes(), format!("127.0.0.1:{}", test_port1))
            .unwrap();
        sender
            .send_to(msg2.as_bytes(), format!("127.0.0.1:{}", test_port2))
            .unwrap();
        sender
            .send_to(msg3.as_bytes(), format!("127.0.0.1:{}", test_port3))
            .unwrap();
    ...
    fn test_port_isolation() {
        ...
        assert!(
            received1.is_ok(),
            "Consumer 1 should receive port 1's message"
        );
