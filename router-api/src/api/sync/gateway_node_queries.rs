...
mod tests {
    ...
    fn test_get_all_gateway_nodes() {
        ...
        if !nodes.is_empty() {
            ...
            assert!(first_node.priority >= -128 && first_node.priority <= 127, 
                    "Priority should be a valid i8 value");
            assert!(!first_node.addr_listen.is_empty(), "addr_listen should not be empty");
            assert!(!first_node.addr_target.is_empty(), "addr_target should not be empty");
            assert!(!first_node.path_listen.is_empty(), "path_listen should not be empty");
            assert!(!first_node.path_target.is_empty(), "path_target should not be empty");
        }
    }
