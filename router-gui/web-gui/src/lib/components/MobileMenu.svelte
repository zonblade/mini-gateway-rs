...
>
    ...
    <div class="relative flex-1 flex flex-col max-w-xs w-full pt-5 pb-4 bg-white dark:bg-[#161b22] shadow-lg transform transition-all {isOpen ? 'translate-x-0 opacity-100' : '-translate-x-4 opacity-0'}">
        ...
        <div class="px-4 py-3 border-b border-gray-200 dark:border-gray-700 mb-3">
            <div class="flex items-center">
                ...
                <div class="ml-3">
                    ...
                    <button 
                        on:click={onLogout}
                        class="mt-1 inline-flex items-center px-2.5 py-1.5 border border-transparent text-xs font-medium rounded text-red-700 bg-red-100 hover:bg-red-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500"
                    >
                        Logout
                    </button>
                </div>
        ...
        <nav class="mt-2 flex-1 px-4 space-y-1">
            ...
            <a href="/settings" class="group flex items-center px-2 py-3 text-base font-medium rounded-md hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors border-l-4 border-transparent hover:border-indigo-500">
                <svg xmlns="http://www.w3.org/2000/svg" class="mr-3 h-6 w-6 text-gray-500 group-hover:text-gray-900 dark:text-gray-400 dark:group-hover:text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <a href="/gateway" class="group flex items-center px-2 py-3 text-base font-medium rounded-md hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors border-l-4 border-transparent hover:border-indigo-500">
                <svg xmlns="http://www.w3.org/2000/svg" class="mr-3 h-6 w-6 text-gray-500 group-hover:text-gray-900 dark:text-gray-400 dark:group-hover:text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
